...
function DocsXVendedor(){
    ...
    useEffect( async() =>{
        ...
        const cantDocs = await sellers.reduce (async(docsSum,seller) => {
            ...
            const docsSumNumber = await docsSum

            const saldoUnformat = invoices.length
            const saldo = saldoUnformat
            ...
            return docsSumNumber + invoices.length
