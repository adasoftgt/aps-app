...
import  SubItemsAccordion  from "components/Accortion/SubItemsAccordion";
...
function Sidebar(props) {
  ...
  const createLinks = (routes) => {
    ...
    return routes.map((prop, key) => {
      ...
      /**
       * Comprobar si la propiedad "visibleInNav" existe
       * @property {boolean} checkPropVisibleInNav chekear si existe la propiedad 
       */
      const checkPropVisibleInNav = prop.hasOwnProperty("visibleInNav");
      
      const visibleInNav = (checkPropVisibleInNav) ? (prop.visibleInNav) ? true : false  : true
      ...
      /**
       * @property {Array} caps array de la capacidades que pueden ver esta ruta
       */
      const {caps} = prop
...
export function SidebarResponsive(props) {
  ...
  const activeRoute = (routeName) => {
    ...
    return location.pathname.toLowerCase() === routeName.toLowerCase() ? "active" : "";
  };
  ...
  const createLinks = (routes) => {
    return routes.map((prop, key) => {
      /**
       * @property {boolean} checkPropVisibleInNav verificar que exista la propiedad "visibleInNav"
       */
      const checkPropVisibleInNav = prop.hasOwnProperty("visibleInNav");
      
      /**
       * @property {boolean} visibleInNav verificar el estado de la ruta true | false si la propiedad "visibleInNav" no exite en l ruta por defecto es true 
       */
      const visibleInNav = (checkPropVisibleInNav) ? (prop.visibleInNav) ? true : false  : true
